'''
Download all *_eeg.json files from Pennsieve datasets.
...
def download_eeg_jsons():
    """Main function to download all *_eeg.json files."""
    ...
    for ds in datasets:
        ...
        # Find and download *_eeg.json files
        eeg_json_count = 0
        for pkg in packages:
            ...
            # Only process *_eeg.json files
            if not pkg_name.endswith("_eeg.json"):
                continue
            ...
            try:
                ...
                # Create output subfolder: output/eegJson_check/download_eegjson/<patient_id>/<session>/
        ...
        if eeg_json_count == 0:
            print("  No *_eeg.json files found")
