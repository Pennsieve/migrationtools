...
class EegJSON(Sidecar):
    ...
    DEFAULTS = {
        ...
        "TaskName": "PRV",
        "TaskDescription": "EEG studies for the PREVeNT Trial (prv) will be recorded for one hour, incorporating both 20mins of sleep and wakefulness. Recordings can be up to 80min to attempt to capture sleep.",
    ...
    SCHEMA = {
        ...
        "properties": {
            ...
            "SoftwareFilters": {"type": ["object", "string"]},
