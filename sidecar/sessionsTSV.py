...
class SessionsTSV(Sidecar):
    ...
    REQUIRED_FIELDS = {"session_id", "session_description", "subject_age_months", "sleep_captured"}
    ...
    def __init__(self, fields: List[Dict[str, Any]], **kwargs):
        ...
        Args:
            fields: List of dictionaries, each representing a session row
                   Example: [
                       {"session_id": "ses-visit03m", "session_description": "baseline", "subject_age_months": 3.1, "sleep_captured": "yes"},
                       {"session_id": "ses-visit18m", "session_description": "followup", "subject_age_months": 18.5, "sleep_captured": "yes"}
                   ]
        """
